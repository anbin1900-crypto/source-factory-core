...
def validate_consumer(consumer: Mapping[str, Any]) -> dict[str, Any]:
    findings=[]
    if consumer.get("cycle_id") != "A-LOOP-GROUP-03-GROUP03-W05-CYCLE-0003": findings.append("CYCLE_ID_MISMATCH")
    if consumer.get("directive_comment_id") != 5184905567: findings.append("DIRECTIVE_COMMENT_MISMATCH")
    authority=consumer.get("source_authority",{}); c3=authority.get("c3",{})
    expected_c3={"latest_pointer":"344cd19f110c825ac3ac6cdc6c2b70571eae3a55","closure_matrix":"38080751c429d0ffe445ff9831126c984c458f0c","rejection_input":"73b49771eab3f00e27705aca5e124f02762e1c5f","upstream_request_bundle":"9b33d6903847d7537c558ed1720e9747a83fab46","test_result":"539c61e13439b1c73f5acd8ffaf0b08394e2bf76","final_report_v3":"deddc17561df452e7ff90951cdb1e80683bba730"}
    for k,v in expected_c3.items():
        if c3.get(k,{}).get("blob") != v: findings.append(f"C3_{k.upper()}_BLOB_MISMATCH")
    if c3.get("latest_pointer",{}).get("terminal_bound_pointer_blob") != "64cdf3632837a9e867b32d82557640c9ff35453c": findings.append("C3_TERMINAL_BOUND_POINTER_BLOB_MISMATCH")

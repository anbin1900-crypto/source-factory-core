...
function handleRpc(message) {
  ...
  try {
    ...
    if (message.method === "initialize") return { jsonrpc: "2.0", id, result: { protocolVersion: "2025-03-26", capabilities: { tools: {} }, serverInfo: { name: "yolla-panel-v6-control-plane", version: "6.0.2" } } };
